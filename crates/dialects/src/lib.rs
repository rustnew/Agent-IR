...
/// One row of the signature table below.
///
/// The argument list is long because the table has that many columns; naming a
/// struct for it would move the same information one level away from the rows,
/// which is where it is easiest to read and hardest to get wrong.
...
fn signatures() -> Vec<OpSignature> {
    ...
    vec![
        ...
        op(
            CORE,
            "cast",
            "Reinterprets a value at another type.",
            Exact(1),
            Exact(1),
            Exact(0),
            NO_ATTRS,
        ...
        op(
            CORE,
            "cmp",
            "Compares two values; the literal is the predicate.",
            Exact(2),
            Exact(1),
            Exact(0),
            NO_ATTRS,
        ...
        op(
            AGENT,
            "func",
            "An agent program entry point; the literal is its name.",
            Exact(0),
            Exact(0),
            Exact(1),
            NO_ATTRS,
        ...
        op(
            AGENT,
            "context",
            "The working context: objective and constraints.",
            Any,
            Exact(1),
            Exact(0),
            NO_ATTRS,
        ...
        op(
            AGENT,
            "action",
            "An action the agent takes; the literal names it.",
            Any,
            Any,
            Exact(0),
            NO_ATTRS,
        ...
        op(
            AGENT,
            "budget",
            "Declares the execution budget of §9.1.",
            Exact(0),
            Exact(0),
            Exact(0),
            NO_ATTRS,
        ...
        op(
            AGENT,
            "verify",
            "Checks a capability before an effectful action (I2).",
            Any,
            Exact(0),
            Exact(0),
            &[("capability", AttrKind::Str)],
            PURE_ONLY,
            false,
            false,
        ),
        ...
        op(
            CONTROL,
            "if",
            "Executes its region when the operand holds.",
            Exact(1),
            Any,
            Between(1, 2),
            NO_ATTRS,
        ...
        op(
            CONTROL,
            "while",
            "Repeats its body while the condition region yields true.",
            Any,
            Any,
            Exact(2),
            &[("max_iterations", AttrKind::Int)],
            PURE_ONLY,
            false,
            false,
        ),
        op(
            CONTROL,
            "loop",
            "Iterates its body over the elements of the operand.",
            Exact(1),
            Any,
            Exact(1),
            &[("max_iterations", AttrKind::Int)],
        ...
        op(
            CONTROL,
            "parallel",
            "Executes its region's operations concurrently (I3).",
            Any,
            Any,
            Exact(1),
            NO_ATTRS,
        ...
        op(
            CONTROL,
            "yield",
            "Yields values out of the enclosing region.",
            Any,
            Exact(0),
            Exact(0),
            NO_ATTRS,
        ...
        op(
            TOOL,
            "call",
            "Invokes a tool; the literal names it.",
            Any,
            Any,
            Exact(0),
            NO_ATTRS,
        ...
        op(
            TOOL,
            "result",
            "Projects one field out of a tool result.",
            Exact(1),
            Exact(1),
            Exact(0),
            &[("field", AttrKind::Str)],
        ...
        op(
            TOOL,
            "capability",
            "Materializes a held capability as a value.",
            Exact(0),
            Exact(1),
            Exact(0),
            &[("capability", AttrKind::Str)],
        ...
        op(
            MEMORY,
            "read",
            "Reads an entry from the memory store.",
            Any,
            Exact(1),
            Exact(0),
            &[("key", AttrKind::Str)],
        ...
        op(
            MEMORY,
            "write",
            "Writes an entry to the memory store.",
            Exact(1),
            Exact(0),
            Exact(0),
            &[("key", AttrKind::Str)],
        ...
        op(
            MEMORY,
            "search",
            "Searches memory for entries relevant to the operand.",
            Any,
            Exact(1),
            Exact(0),
            NO_ATTRS,
        ...
        op(
            OBSERVATION,
            "create",
            "Turns a raw result into a typed observation.",
            Exact(1),
            Exact(1),
            Exact(0),
            NO_ATTRS,
        ...
        op(
            OBSERVATION,
            "metric",
            "Extracts a named metric from an observation.",
            Exact(1),
            Exact(1),
            Exact(0),
            NO_ATTRS,
